...
export default function HomePage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Include ways for people to reach you.",
    },
    {
      icon: Share2Icon,
      title: "Connect Social Media",
      description: "Link your social profiles to expand your reach.",
    },
  ];
  ...
  const features = [
    ...
    },
    {
      icon: RocketIcon,
      title: "Quick Launch",
      description: "Go live with your landing page in minutes, not hours.",
    },
  ];
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden ">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center pt-20 md:pt-32 pb-16">
          ...
          >
            <span className="text-lg font-sans text-primary/60 tracking-wide">
              QRBook
            </span>
          </motion.div>
          ...
          >
            <p className="text-md sm:text-lg md:text-xl text-primary/40 mb-8 leading-relaxed font-sans tracking-wide max-w-xl mx-auto px-4">
              Design, generate, and share stunning landing pages in minutes. Get
              started with just a few clicks!
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto mb-24">
          <h2 className="text-xl md:text-3xl font-sans text-center text-primary mb-12 font-extrabold">
            How It Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-sans text-primary mb-2 font-bold">
                  {step.title}
                </h3>
                <p className="text-primary/60 font-sans text-md">
                  {step.description}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-3xl mx-auto mb-24">
          <h2 className="text-xl md:text-3xl font-sans text-center text-primary font-extrabold mb-12">
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`}>
                ...
                <AccordionContent className="text-primary/60 font-sans text-md">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
